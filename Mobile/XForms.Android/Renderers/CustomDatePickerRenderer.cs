...
namespace XForms.Droid.Renderers
{
    public class CustomDatePickerRenderer : DatePickerRenderer
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<DatePicker> e)
        {
            ...
            if (((CustomDatePicker)this.Element).IsCustom)
            {
                UpdateControl();
            }
            else
            {
                Control.SetBackgroundResource(Resource.Layout.DateStyle);
            }
        }
        ...
        protected override void OnElementPropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == CustomDatePicker.TextColorProperty.PropertyName ||
                e.PropertyName == CustomDatePicker.BorderColorProperty.PropertyName ||
                e.PropertyName == CustomDatePicker.BackgroundColorProperty.PropertyName)
            {
                UpdateControl();
            }
        }
        ...
        private void UpdateControl()
        {
            try
            {
                element = (CustomDatePicker)Element;
