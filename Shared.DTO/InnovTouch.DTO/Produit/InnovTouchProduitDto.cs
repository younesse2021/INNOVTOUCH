...
{
    public class InnovTouchProduitDto
    {
        ...
        public string DisplayQNt { get { return $"Quantite   :  {QteInitiale}"; } }
        public string DisplayNbDay { get { return $"Le nombre de jours restant :   {NbrJourRestant}"; } }
        public string DisplayInnovTouch { get { return $"InnovTouch  :   {InnovTouch.ToString("dd-MM-yyyy")}"; } }
        public string DisplayFamilleProduit { get { return $"Libelle : {Produit.Libelle}"; } }
