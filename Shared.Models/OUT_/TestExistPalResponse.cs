...
namespace Shared.Models.OUT.TestExistPalResponse
{
    ...
    public class TestExistPalResult
    {
        public string Site { get; set; }
    ...
    public class ResponsePDATestExistPal
    {
        public TestExistPalResult Result { get; set; }
    }

    public class SOAPENVBody
    {
        public ResponsePDATestExistPal Response_PDATestExistPal { get; set; }
    }
    ...
    public class TestExistPalResponse
    {
