...
namespace Shared.Models.OUT.UpdateArrivageResponse
{
    ...
    public class UpdateArrivageResult
    {
    ...
    public class ResponsePDAUpdateArrivage
    {
        public UpdateArrivageResult Result { get; set; }
    }

    public class SOAPENVBody
    {
        public ResponsePDAUpdateArrivage Response_PDAUpdateArrivage { get; set; }
    }
    ...
    public class UpdateArrivageResponse
    {
