...
namespace Shared.Models.OUT.AddOrUpdateControlePrixResponse
{
    ...
    public class ResponsePDAControlePrixSaveControl
    {
    ...
    {
        public ResponsePDAControlePrixSaveControl Response_PDAControlePrixSaveControl { get; set; }
    }
    ...
    public class AddOrUpdateControlePrixResponse
    {
