...
namespace Shared.Models.OUT_
{
    ...
    public class Data
    {
        ...
        public object rejectedArticles { get; set; }
    }

    public class ResponseGWSPrepareEtiquettes
    {
    ...
    {
        public ResponseGWSPrepareEtiquettes Response_GWSPrepareEtiquettes { get; set; }
    }
    ...
    public class CreateEtiquetteResponse
    {
