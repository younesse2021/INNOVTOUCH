...
namespace Shared.Models.OUT.ControlePrixEtiquetteResponse
{
    ...
    public class ResponsePDAControlePrixEtiquette
    {
    ...
    {
        public ResponsePDAControlePrixEtiquette Response_PDAControlePrixEtiquette { get; set; }
    }
    ...
    public class ControlePrixEtiquetteResponse
    {
