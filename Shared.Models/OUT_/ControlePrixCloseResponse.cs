...
namespace Shared.Models.OUT.ControlePrixCloseResponse
{
    ...
    public class ResponsePDAControlePrixCloseControl
    {
    ...
    {
        public ResponsePDAControlePrixCloseControl Response_PDAControlePrixCloseControl { get; set; }
    }
    ...
    public class ControlePrixCloseResponse
    {
