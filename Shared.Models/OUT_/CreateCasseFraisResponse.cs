...
namespace Shared.Models.OUT_.CreateCasseFraisResponse
{
    ...
    public class ResponseGWSSetArticlesCasseFraisMarj
    {
    ...
    {
        public ResponseGWSSetArticlesCasseFraisMarj Response_GWSSetArticlesCasseFraisMarj { get; set; }
    }
    ...
    public class CreateCasseFraisResponse
    {
